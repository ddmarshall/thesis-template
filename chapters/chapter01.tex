...
\section{Tables} \label{sec:Tables}
    ...
    \begin{table}
        ...
        \begin{tabular}{c S S S S}
                      & \multicolumn{1}{c}{Ref.}
                               & \multicolumn{1}{c}{Calc.}
                                        & \multicolumn{1}{c}{Absolute}
...
\section{Nomenclature Usage} \label{sec:NomenclatureUsage}
    ...
    This uses the nomencl package, and you should consult the documentation for that package to see how it can be used.
    \textbf{
